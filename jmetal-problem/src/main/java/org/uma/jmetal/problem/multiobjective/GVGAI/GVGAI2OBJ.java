...
public class GVGAI2OBJ extends AbstractDoubleProblem {
    ...
    public void setProblemArguments(int[] gameIdx, String level){
        ...
        this.level = level;
        this.gameFiles = new String[gameIdx.length];
        this.levelFiles = new String[gameIdx.length];
        this.run();
    }
     ...
     */
    public GVGAI2OBJ(Integer numberOfVariables) {
