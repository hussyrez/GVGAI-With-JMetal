...
public class ButterfliesChase extends AbstractDoubleProblem {

  private static final String CONFIG_PATH = "gvgai/config/config.txt";

  public ButterfliesChase() {
    this(4);
  }
   ...
   */
  public ButterfliesChase(Integer numberOfVariables) {
    setNumberOfVariables(numberOfVariables);
    setNumberOfObjectives(2);
    setName("ButterfliesChase");
