...
public class AliensButterfliesChase extends AbstractDoubleProblem {

  private static final String CONFIG_PATH = "gvgai/config/config.txt";

  public AliensButterfliesChase() {
    this(4);
  }
   ...
   */
  public AliensButterfliesChase(Integer numberOfVariables) {
    setNumberOfVariables(numberOfVariables);
    setNumberOfObjectives(3);
    setName("AliensButterfliesChase");
  ...
  public void evaluate(DoubleSolution solution) {
    ...
    game = gamesPath + games[gameIdx + 2] + ".txt";
    level1 = gamesPath + games[gameIdx + 2] + "_lvl" + levelIdx + ".txt";
    f[2] = 1.0 / ArcadeMachine.runOneGame(game, level1, false, suntzuController, null, seed, 0)[1];
    f[2] = f[2] < 0 ? 1000.0 : f[2];
