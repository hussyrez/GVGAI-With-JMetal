...
/**
 * Class to configure and run the NSGA-II algorithm (variant with measures) on GVGAI instances.
 */
public class NSGAIIHyperGVGAIRunner extends AbstractAlgorithmRunner {
    /**
    ...
    public static void main(String[] args)
        ...
        if (args.length == 2) {
            ...
            referenceParetoFront = "jmetal-problem/src/test/resources/pareto_fronts/GVGAI2OBJ.pf"; //1: {Aliens, Butterflies}
        }

        /* our problem */
        problem = ProblemUtils.<DoubleSolution> loadProblem(problemName);
        int[] gameIdx = {1,2};
        ((GVGAI2OBJ) problem).setProblemArguments(gameIdx, "0");
